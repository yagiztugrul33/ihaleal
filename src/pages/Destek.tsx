    ...
    <div className="min-h-screen pt-24 pb-16 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center gap-3 mb-4">
          <LifeBuoy className="w-7 h-7 text-[var(--metin-ikincil)]" />
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-8">
          <Link
            to="/sss"
            className="rounded-[20px] border border-[var(--cizgi)] bg-slate-900/40 p-5 hover:border-[var(--cizgi)] transition-colors block"
          >
            <FileQuestion className="w-8 h-8 text-[var(--metin-ikincil)] mb-3" />
          ...
          <Link
            to="/rehber"
            className="rounded-[20px] border border-slate-700/50 bg-slate-900/40 p-5 hover:border-[var(--cizgi)] transition-colors block"
          >
            <HelpCircle className="w-8 h-8 text-[var(--metin-ikincil)] mb-3" />
          ...
          <Link
            ...
            className="rounded-[20px] border border-slate-700/50 bg-slate-900/40 p-5 hover:border-[var(--cizgi)] transition-colors block"
          >
            <MessageSquare className="w-8 h-8 text-[var(--metin-ikincil)] mb-3" />
          ...
          <Link
            ...
            className="rounded-[20px] border border-slate-700/50 bg-slate-900/40 p-5 hover:border-[var(--cizgi)] transition-colors block"
          >
            <ShieldCheck className="w-8 h-8 text-[var(--metin-ikincil)] mb-3" />
        ...
        <div className="rounded-[20px] border border-[var(--cizgi)] bg-[var(--zemin-yumusak)] p-5 mb-6">
          <h3 className="text-base font-normal text-[var(--metin-ikincil)] mb-2 flex items-center gap-2">
            <Mail className="w-5 h-5" /> E-posta
          </h3>
          <p className="text-slate-200 text-sm">
            Doğrudan e-posta: <a href="mailto:info@ihaleal.com" className="text-[var(--metin-ikincil)] underline">info@ihaleal.com</a>
          </p>

      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6">
        ...
        <section className="mb-6 space-y-3">
          <div className="rounded-[20px] border border-[var(--cizgi)] bg-slate-900/40 p-4">
            <p className="text-sm font-normal text-[var(--metin-ikincil)] mb-2">Değerleme nasıl hesaplanır?</p>
            <div className="grid sm:grid-cols-3 gap-3 text-xs">
              <div className="rounded-[10px] border border-[var(--cizgi)] bg-slate-900/30 p-3">
                <p className="font-normal text-[var(--metin-ikincil)] mb-1">1. Bölge Baz Fiyatı</p>
                <p className="text-slate-300">
                  İl/ilçe ortalama m² satış fiyatı — TCMB Konut Fiyat Endeksi + platform verisi.
                </p>
              </div>
              <div className="rounded-[10px] border border-[var(--cizgi)] bg-slate-900/30 p-3">
                <p className="font-normal text-[var(--metin-ikincil)] mb-1">2. Hedonik Katman</p>
                <p className="text-slate-300">
                  Bina yaşı, kat, ısıtma, asansör, otopark, manzara → yıpranma/prim çarpanı.
                </p>
              </div>
              <div className="rounded-[10px] border border-[var(--cizgi)] bg-slate-900/30 p-3">
                <p className="font-normal text-[var(--metin-ikincil)] mb-1">3. Emsal Karşılaştırma</p>
                <p className="text-slate-300">
          ...
          <div className="rounded-[20px] border border-[var(--cizgi)] bg-[var(--zemin-yumusak)] p-4 text-[var(--metin-ikincil)]">
          ...
          <div className="rounded-[20px] border border-[var(--cizgi)] bg-slate-900/40 p-4">
            <p className="text-sm font-normal text-[var(--metin-ikincil)] mb-3">📊 5 Bölge m² Rayiç + Yıllık Trend (2026 Q2)</p>
              ...
              <table className="w-full text-xs min-w-[520px]">
                ...
                <tbody className="text-slate-300">
                  <tr className="border-b border-slate-800/50">
                    ...
                    <td className="py-2 px-2 text-end text-[var(--metin-ikincil)]">+%28</td>
                    <td className="py-2 px-2 text-end">₺350</td>
                    <td className="py-2 px-2 text-end text-[var(--metin-ikincil)]">%5.6</td>
                    <td className="py-2 ps-2 text-end text-[var(--metin-ikincil)]">⚡ Hızlı</td>
                  </tr>
                  <tr className="border-b border-slate-800/50">
                    <td className="py-2 pe-2">
                    ...
                    <td className="py-2 px-2 text-end text-[var(--metin-ikincil)]">+%18</td>
                    <td className="py-2 px-2 text-end">₺180</td>
                    <td className="py-2 px-2 text-end text-[var(--metin-ikincil)]">%5.7</td>
                    <td className="py-2 ps-2 text-end text-[var(--metin-ikincil)]">⚡ Hızlı</td>
                  </tr>
                  <tr className="border-b border-slate-800/50">
                    <td className="py-2 pe-2">
                    ...
                    <td className="py-2 px-2 text-end text-[var(--metin-ikincil)]">+%24</td>
                    <td className="py-2 px-2 text-end">₺265</td>
                    <td className="py-2 px-2 text-end text-[var(--metin-ikincil)]">%6.1</td>
                    <td className="py-2 ps-2 text-end text-[var(--metin-ikincil)]">🚀 Orta</td>
                  </tr>
                  <tr className="border-b border-slate-800/50">
                    <td className="py-2 pe-2">
                    ...
                    <td className="py-2 px-2 text-end text-[var(--metin-ikincil)]">+%32</td>
                    <td className="py-2 px-2 text-end">₺290</td>
                    <td className="py-2 px-2 text-end text-[var(--metin-ikincil)]">%7.9</td>
                    <td className="py-2 ps-2 text-end text-[var(--metin-ikincil)]">⏳ Mevsim</td>
                  </tr>
                  <tr>
                    <td className="py-2 pe-2">
                    ...
                    <td className="py-2 px-2 text-end text-[var(--metin-ikincil)]">+%21</td>
                    <td className="py-2 px-2 text-end">₺145</td>
                    <td className="py-2 px-2 text-end text-[var(--metin-ikincil)]">%6.2</td>
        ...
        >
          ...
          {error ? <p className="md:col-span-2 text-sm text-[var(--metin-ikincil)]">{error}</p> : null}
        </form>
            ...
            <section className="mt-6 rounded-[20px] border border-[var(--cizgi)] bg-[var(--zemin-yumusak)] p-6">
              <div className="flex items-start justify-between flex-wrap gap-3 mb-4">
                ...
                <div className="text-end">
                  <div className="text-3xl md:text-4xl font-normal text-[var(--metin-ikincil)]">
                    {formatTry(result.estimatedValue)}
                    {form.transactionType === "rent" ? <span className="text-sm font-normal text-slate-400"> /ay</span> : null}
                  </div>
                  {showFx && (
                    <div className="text-[11px] text-[var(--metin-ikincil)] mt-0.5">
              ...
              <div className="mb-1 flex items-center justify-between text-xs text-slate-400">
                ...
                <span className="text-[var(--metin-ikincil)] font-normal">±%{result.confidenceBandPct}</span>
                <span>{formatTry(result.maxValue)}</span>
              </div>
              {showFx && (
                <p className="mt-1 text-[10px] text-[var(--metin-ikincil)] text-end italic">
                  Aralık ≈ {formatFromTry(result.minValue)} – {formatFromTry(result.maxValue)} (yaklaşık)
                </p>
              )}
              <div className="relative h-3 rounded-full bg-slate-800 overflow-hidden">
                <div
                  className="absolute top-0 h-full bg-[var(--zemin-yumusak)]"
                  style={{ left: "10%", right: "10%" }}
                />
                <div
                  className="absolute top-1/2 -translate-y-1/2 w-3 h-3 rounded-full bg-[var(--zemin-yumusak)] ring-2 ring-[var(--cizgi)]"
                  style={{ left: "calc(50% - 6px)" }}
                  title="Merkez tahmin"
                />
              </div>
              <p className="mt-3 text-sm text-[var(--metin-ikincil)]">{result.note}</p>
            </section>
            ...
            <section className="mt-4 grid gap-4 md:grid-cols-2">
              <div className="rounded-[20px] border border-white/10 bg-slate-900/40 p-5">
                <h3 className="text-sm font-normal uppercase tracking-wider text-slate-300 mb-3 flex items-center gap-2">
                  <TrendingUp className="h-4 w-4 text-[var(--metin-ikincil)]" /> Bölge Ortalaması Karşılaştırma
                </h3>
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <strong className="text-[var(--metin-ikincil)]">{formatTry(userUnit)}/m²</strong>
                  </div>
                  <div
                    className={cn(
                      "rounded-[10px] px-3 py-2 text-sm font-normal",
                      Math.abs(compareDelta) < 5 ? "bg-slate-800 text-slate-200" : "bg-[var(--zemin-yumusak)]",
                    )}
                    style={Math.abs(compareDelta) >= 5 ? { color: compareDelta > 0 ? "var(--sinyal-turuncu)" : "var(--metrik-yesil)" } : undefined}
                  >
              ...
              <div className="rounded-[20px] border border-white/10 bg-slate-900/40 p-5">
                <h3 className="text-sm font-normal uppercase tracking-wider text-slate-300 mb-3 flex items-center gap-2">
                  <Building2 className="h-4 w-4 text-[var(--metin-ikincil)]" /> Hesaplama Katmanları (₺/m²)
                </h3>
                <div className="space-y-2 text-xs">
                  {[
                    { label: "Bölge baz", value: result.layerSummary.baseUnitPrice, color: "bg-slate-500" },
                    { label: "Hedonik (özellik)", value: result.layerSummary.hedonicUnitPrice, color: "bg-[var(--zemin-yumusak)]" },
                    { label: "Emsal (komşu)", value: result.layerSummary.comparableUnitPrice, color: "bg-[var(--zemin-yumusak)]" },
                  ].map((row) => {
                    const maxv = Math.max(
            ...
            <section className="mt-4 rounded-[20px] border border-white/10 bg-slate-900/40 p-5">
              <div className="flex flex-wrap items-center justify-between gap-3 mb-3">
                <h3 className="text-sm font-normal uppercase tracking-wider text-slate-300 flex items-center gap-2">
                  <Sparkles className="h-4 w-4 text-[var(--metin-ikincil)]" /> AI Yorum + PDF Rapor
                </h3>
              ...
              {aiReply ? (
                <div className="rounded-[20px] border border-[var(--cizgi)] bg-[var(--zemin-yumusak)] px-4 py-3 text-sm text-[var(--metin-ikincil)] leading-relaxed whitespace-pre-line">
                  {aiReply}
                </div>
              ) : (
                <p className="text-xs text-slate-400">
                    ...
                    >
                      ...
                      <div className="p-3 space-y-1">
                        ...
                        <div className="flex items-center justify-between pt-1">
                          <span className="text-sm font-normal text-[var(--metin-ikincil)]">{formatTry(a.currentBid)}</span>
        ...
        <section className="mt-12 space-y-4">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="rounded-[20px] border border-[var(--cizgi)] bg-slate-900/40 p-4">
              <p className="text-sm font-normal text-[var(--metin-ikincil)] mb-2">Hesap Katmanları</p>
              <ul className="text-xs text-slate-300 space-y-1.5">
            ...
            <div className="rounded-[20px] border border-[var(--cizgi)] bg-slate-900/40 p-4">
              <p className="text-sm font-normal text-[var(--metin-ikincil)] mb-2">Doğrulama Çerçevesi</p>
              <ul className="text-xs text-slate-300 space-y-1.5">
            ...
            <div className="rounded-[20px] border border-[var(--cizgi)] bg-[var(--zemin-yumusak)] p-4">
              <p className="text-sm font-normal text-[var(--metin-ikincil)] mb-2">Disclaimer</p>

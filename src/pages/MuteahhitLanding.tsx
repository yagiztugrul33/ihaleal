    ...
    <div className="min-h-screen kurumsal-page">
      ...
      <section className="py-12 border-y border-[var(--color-border)]" style={{ background: "var(--zemin-yumusak)" }}>
        <div className="mx-auto max-w-5xl px-4 flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            <h2 className="text-xl md:text-2xl font-normal" style={{ color: "var(--color-text)" }}>
        ...
        <div className="mx-auto max-w-6xl px-4">
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-3">
            <article className="card-warm">
              <h3 className="text-lg font-normal" style={{ color: "var(--color-text)" }}>1) Proje panelini kur</h3>
              <p className="mt-2 text-sm" style={{ color: "var(--color-text-muted)" }}>
                Faz, lot, maliyet ve hakediş adımlarını panelde tanımla.
              </p>
            </article>
            <article className="card-warm">
              <h3 className="text-lg font-normal" style={{ color: "var(--color-text)" }}>2) İhaleyi aç ve yönet</h3>
              <p className="mt-2 text-sm" style={{ color: "var(--color-text-muted)" }}>
                Kapalı teklif veya açık ihale modelini seç, teklifleri karşılaştır.
              </p>
            </article>
            <article className="card-warm">
              <h3 className="text-lg font-normal" style={{ color: "var(--color-text)" }}>3) Kapanış ve devir</h3>
              <p className="mt-2 text-sm" style={{ color: "var(--color-text-muted)" }}>
      ...
      <section className="py-20 md:py-24">
        <div className="mx-auto max-w-6xl px-4">
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl md:text-4xl font-normal mt-4" style={{ color: "var(--color-text)" }}>
              ...
              return (
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-normal" style={{ color: "var(--color-text)" }}>
                        {p.title} - {p.city}
                      </h3>
                      ...
                      <span
                        className="inline-block mt-3 text-xs font-normal px-2 py-1 rounded-full"
                        style={{ background: "var(--color-bg-soft)", color: "var(--color-text)" }}
                      >
                        {p.status}
                      </span>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-4xl px-4">
          <div className="rounded-[20px] overflow-hidden border border-[var(--color-border)]">
      ...
      <section className="py-14 md:py-18" style={{ background: "var(--zemin-yumusak)" }}>
        <div className="mx-auto max-w-6xl px-4">
          ...
          <div className="mt-6 grid gap-4 lg:grid-cols-2">
            <article className="card-warm">
              <h3 className="text-lg font-normal" style={{ color: "var(--color-text)" }}>Örnek senaryo</h3>
            ...
            <div className="grid gap-3">
              <article className="card-warm">
                <p className="text-sm font-normal text-white">KKA zorunlu mu?</p>
                <p className="mt-1 text-xs text-slate-400">Hayır. Proje tipine göre bağımsız ihale akışı da kullanılabilir.</p>
              </article>
              <article className="card-warm">
                <p className="text-sm font-normal text-white">Finansal hesaplar bağlayıcı mı?</p>
                <p className="mt-1 text-xs text-slate-400">Hayır, demo/ön analizdir. Sözleşme ve uzman onayı ile kesinleşir.</p>
              </article>
              <article className="card-warm">
                <p className="text-sm font-normal text-white">Hangi CTA ile başlamak gerekir?</p>
      ...
      <section className="py-14">
        <div className="mx-auto max-w-6xl px-4">
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-3">
            <article className="card-warm">
              <h3 className="text-lg font-normal" style={{ color: "var(--color-text)" }}>İşlem bazlı tahakkuk</h3>
              <p className="mt-2 text-sm" style={{ color: "var(--color-text-muted)" }}>
                Gelir proje ve teslim adımlarına bağlı ilerler; sadece ilan paketi satışıyla gelir yazılmaz.
              </p>
            </article>
            <article className="card-warm">
              <h3 className="text-lg font-normal" style={{ color: "var(--color-text)" }}>By-pass yok</h3>
              <p className="mt-2 text-sm" style={{ color: "var(--color-text-muted)" }}>
                Tekliften kapanışa kayıtlı akış korunur; platform dışı kısa yol modeli teşvik edilmez.
              </p>
            </article>
            <article className="card-warm">
              <h3 className="text-lg font-normal" style={{ color: "var(--color-text)" }}>Dürüst sınır</h3>
              <p className="mt-2 text-sm" style={{ color: "var(--color-text-muted)" }}>
      ...
      <section className="py-16 md:py-20 vurgu-yuzey">
        <div className="mx-auto max-w-3xl px-4 text-center">
          <h2 className="text-2xl md:text-4xl font-normal mb-4" style={{ color: "var(--uzerine)" }}>

    ...
    <>
      ...
      <div className="rounded-[20px] border border-white/10 bg-white/[0.03] p-5">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-lg font-normal text-white">Son ilanlar (demo)</h2>
...
export default function EmlakciPanelPage() {
  ...
  return (
    ...
    >
      ...
      <div className={useLive ? "" : "mt-8 rounded-[20px] border border-dashed border-white/15 overflow-hidden"}>
      ...
      <section className="mt-6 rounded-[20px] border border-white/10 bg-white/[0.03] p-5">
        <h3 className="text-lg font-normal text-white">Nasıl çalışır?</h3>
        <div className="mt-3 grid gap-3 md:grid-cols-3 text-sm">
          <article className="rounded-[10px] border border-white/10 p-3">
            <p className="font-normal text-slate-100">1) Portföy hazırlığı</p>
            <p className="mt-1 text-slate-400">İlan, evrak ve fiyat bandı aynı panelde tanımlanır.</p>
          </article>
          <article className="rounded-[10px] border border-white/10 p-3">
            <p className="font-normal text-slate-100">2) Teklif yönetimi</p>
            <p className="mt-1 text-slate-400">Canlı teklif akışı, müşteri notları ve durum adımlarıyla ilerler.</p>
          </article>
          <article className="rounded-[10px] border border-white/10 p-3">
            <p className="font-normal text-slate-100">3) Kapanış ve tahakkuk</p>
      ...
      <section className="mt-6 rounded-[20px] border border-white/10 bg-white/[0.03] p-5">
        ...
        <div className="mt-3 grid gap-3 md:grid-cols-3 text-sm">
          <article>
            <p className="font-normal text-slate-100">Panel canlı veriyi ne zaman gösterir?</p>
            <p className="text-slate-400 mt-1">Supabase bağlantısı aktif olduğunda canlı organizasyon verisi açılır.</p>
          </article>
          <article>
            <p className="font-normal text-slate-100">Teklif akışı denetlenebilir mi?</p>
            <p className="text-slate-400 mt-1">Evet, teklif geçmişi ve durum adımları kayıtlı ilerler.</p>
          </article>
          <article>
            <p className="font-normal text-slate-100">Hangi sonraki adım önerilir?</p>

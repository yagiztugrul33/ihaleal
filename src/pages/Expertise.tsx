                ...
                <CardContent className="p-5 space-y-4">
                  ...
                  <div className="grid sm:grid-cols-2 gap-3">
                    <div><label className="text-sm text-slate-400 mb-1 block">Emlak Tipi</label>
                      <select value={form.propertyType} onChange={(e) => setForm({...form, propertyType: e.target.value})} className="w-full px-3 py-2 rounded-lg bg-slate-950 border border-slate-200 text-white text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/50">
                    ...
                    <div><label className="text-sm text-slate-400 mb-1 block">Isitma</label>
                      <select value={form.heating} onChange={(e) => setForm({...form, heating: e.target.value})} className="w-full px-3 py-2 rounded-lg bg-slate-950 border border-slate-200 text-white text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/50">
                    ...
                    <div><label className="text-sm text-slate-400 mb-1 block">Cephe</label>
                      <select value={form.facade} onChange={(e) => setForm({...form, facade: e.target.value})} className="w-full px-3 py-2 rounded-lg bg-slate-950 border border-slate-200 text-white text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/50">
                    ...
                    <div><label className="text-sm text-slate-400 mb-1 block">Kullanim Durumu</label>
                      <select value={form.usingStatus} onChange={(e) => setForm({...form, usingStatus: e.target.value})} className="w-full px-3 py-2 rounded-lg bg-slate-950 border border-slate-200 text-white text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/50">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-2">
                    {[
                      ...
                      <label key={item.key} className="flex items-center gap-2 p-3 rounded-xl bg-white/[0.03] border border-slate-200/80 cursor-pointer hover:bg-white/[0.05] transition-colors">
                ...
                <CardContent className="p-5 space-y-4">
                  ...
                  <div className="grid sm:grid-cols-2 gap-3">
                    ...
                    <div><label className="text-sm text-slate-400 mb-1 block">Talep Nedeni</label>
                      <select value={form.requestReason} onChange={(e) => setForm({...form, requestReason: e.target.value})} className="w-full px-3 py-2 rounded-lg bg-slate-950 border border-slate-200 text-white text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/50">

            ...
            <Card className="bg-slate-900/50 border-slate-200/80 sticky top-24">
              <CardContent className="p-6 text-center">
                ...
                <div className="flex items-center justify-center gap-1 mt-2">
                  <Star className="w-4 h-4 text-[var(--metin-ikincil)] fill-amber-400" />
                ...
                <Button onClick={handleLogout} variant="outline" className="w-full mt-4 border-[var(--cizgi)] text-[var(--metin-ikincil)] hover:bg-[var(--zemin-yumusak)] gap-2"><LogOut className="w-4 h-4" /> {pf.logout}</Button>
              </CardContent>
            </Card>
          </div>
          <div className="lg:col-span-2 space-y-6">
            {saveError && <div className="p-3 rounded-[20px] bg-[var(--zemin-yumusak)] border border-[var(--cizgi)] text-[var(--metin-ikincil)] text-sm">{saveError}</div>}
            {success && <div className="flex items-center gap-2 p-3 rounded-[20px] bg-[var(--zemin-yumusak)] border border-[var(--cizgi)] text-[var(--metin-ikincil)]"><CheckCircle2 className="w-4 h-4" /><span className="text-sm">{success}</span></div>}
            <Card className="bg-slate-900/50 border-slate-200/80">
              <CardContent className="p-6">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-lg font-normal text-white flex items-center gap-2"><Edit3 className="w-5 h-5 text-[var(--metin-ikincil)]" /> {pf.profileInfoTitle}</h3>
                ...
                <div className="space-y-4">
                  ...
                  <div><label className="text-sm text-slate-400 mb-1.5 block">{pf.emailLabel}</label>{editMode ? <Input type="email" value={email} onChange={(e) => setEmail(e.target.value)} className="bg-slate-950 border-slate-200 text-white" dir="ltr" /> : <div className="p-3 rounded-[10px] bg-white/[0.03] text-white text-sm flex items-center gap-2"><Mail className="w-4 h-4 text-[var(--metin-ikincil)]" /><span dir="ltr">{user.email}</span>{user.verified && <CheckCircle2 className="w-4 h-4" style={{ color: "var(--metrik-yesil)" }} />}</div>}</div>
                  <div><label className="text-sm text-slate-400 mb-1.5 block">{pf.phoneLabel}</label>{editMode ? <Input value={phone} onChange={(e) => setPhone(e.target.value)} className="bg-slate-950 border-slate-200 text-white" dir="ltr" /> : <div className="p-3 rounded-[10px] bg-white/[0.03] text-white text-sm"><div className="flex items-center gap-2"><Phone className="w-4 h-4 text-[var(--metin-ikincil)]" /><span dir="ltr">{user.phone || pf.phoneNotSet}</span></div><p className="text-[11px] text-slate-500 mt-2">{pf.phoneNote}</p></div>}</div>
            ...
            <Card className="bg-slate-900/50 border-slate-200/80">
              <CardContent className="p-6">
                <h3 className="text-lg font-normal text-white flex items-center gap-2 mb-4"><Shield className="w-5 h-5 text-[var(--metin-ikincil)]" /> {pf.securityTitle}</h3>
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-3 rounded-[10px] bg-white/[0.03]"><span className="text-sm text-white">{pf.emailVerification}</span><span className="text-xs px-2 py-1 rounded-full bg-[var(--zemin-yumusak)]" style={{ color: user.verified ? "var(--metrik-yesil)" : "var(--metin-ikincil)" }}>{user.verified ? pf.statusVerified : pf.statusPending}</span></div>
                  ...
                  <div className="flex items-center justify-between p-3 rounded-[10px] bg-white/[0.03]"><span className="text-sm text-white">{pf.kycVerification}</span><span className="text-xs px-2 py-1 rounded-full bg-[var(--zemin-yumusak)]" style={{ color: kycVerified ? "var(--metrik-yesil)" : "var(--metin-ikincil)" }}>{kycVerified ? pf.statusVerified : pf.statusPending}</span></div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-slate-900/50 border-slate-200/80">
              <CardContent className="p-6">
                <h3 className="text-lg font-normal text-white flex items-center gap-2 mb-4">
                  <Star className="w-5 h-5 text-[var(--metin-ikincil)]" /> {pf.accountSummaryTitle}
                </h3>
                <div className="grid gap-3 sm:grid-cols-2">
                  <Link to="/favoriler" className="flex items-center justify-between p-3 rounded-[10px] bg-white/[0.03] hover:bg-[var(--zemin-yumusak)] border border-transparent hover:border-[var(--cizgi)] transition-colors group">
                    <div className="flex items-center gap-2.5">
                      <Heart className="w-4 h-4 text-[var(--metin-ikincil)]" />
                      <div>
                    ...
                    <ChevronRight className="rtl:rotate-180 w-4 h-4 text-slate-500 group-hover:text-[var(--metin-ikincil)] transition-colors" />
                  </Link>
                  <Link to="/aramalarim" className="flex items-center justify-between p-3 rounded-[10px] bg-white/[0.03] hover:bg-[var(--zemin-yumusak)] border border-transparent hover:border-[var(--cizgi)] transition-colors group">
                    <div className="flex items-center gap-2.5">
                      <Bookmark className="w-4 h-4 text-[var(--metin-ikincil)]" />
                      <div>
                  ...
                  <Link to="/panel/tekliflerim" className="flex items-center justify-between p-3 rounded-[10px] bg-white/[0.03] hover:bg-[var(--zemin-yumusak)] border border-transparent hover:border-[var(--cizgi)] transition-colors group">
                    <div className="flex items-center gap-2.5">
                      <HandCoins className="w-4 h-4 text-[var(--metin-ikincil)]" />
                      <div>
                  ...
                  <Link to="/panel" className="flex items-center justify-between p-3 rounded-[10px] bg-white/[0.03] hover:bg-[var(--zemin-yumusak)] border border-transparent hover:border-[var(--cizgi)] transition-colors group">
                    <div className="flex items-center gap-2.5">
                      <ExternalLink className="w-4 h-4 text-[var(--metin-ikincil)]" />
                      <div>
            ...
            <Card className="bg-slate-900/50 border-slate-200/80">
              <CardContent className="p-6">
                <h3 className="text-lg font-normal text-white flex items-center gap-2 mb-4">
                  <BellRing className="w-5 h-5 text-[var(--metin-ikincil)]" /> {pf.notifyTitle}
                </h3>
                  ...
                  {[
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <Bell className="w-4 h-4 text-[var(--metin-ikincil)] flex-shrink-0" />
                        <div>

        ...
        <ModulePanel title="Örnek ve dürüst sınır">
          <div className="grid gap-3 lg:grid-cols-3">
            <article className="rounded-[10px] border border-slate-700 bg-slate-900/70 p-3 text-sm text-slate-200">
              <h3 className="text-xs font-normal uppercase tracking-[0.12em] text-amber-200">Örnek</h3>
              <p className="mt-2">10 dönüm ~1 MWp, uygun GHI ve kısa trafo mesafesiyle yaklaşık 4-6 yıl payback bandına yaklaşabilir.</p>
            </article>
            <article className="rounded-[10px] border border-slate-700 bg-slate-900/70 p-3 text-sm text-slate-200">
              <h3 className="text-xs font-normal uppercase tracking-[0.12em] text-amber-200">Kime göre</h3>
          ...
          <div className="mt-4 flex flex-wrap items-center justify-between gap-3 rounded-[10px] border border-amber-500/30 bg-amber-500/10 p-3">

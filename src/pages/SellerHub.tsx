      ...
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="mb-10">
          ...
          <p className="text-slate-400 text-sm max-w-3xl">
            ...
            e-Devlet yetkisi, Findeks ve banka doğrulaması <strong className="text-[var(--metin-ikincil)]">canlı entegrasyon + avukat</strong> ile üretimde tamamlanır; bu sayfa ürün ve evrak rehberidir.
          </p>
        </div>

        <div className="p-4 rounded-[20px] bg-[var(--zemin-yumusak)] border border-[var(--cizgi)] text-sm text-slate-400 mb-6 leading-relaxed">
          <strong className="text-[var(--metin-ikincil)]">Belge çizgisi:</strong> İlan oluştururken «Raporlar ve ekspertiz» kartında bölge fiyat raporu (PDF adı, demo), SPK ekspertiz PDF’i ve resmi belge beyanı —{" "}
          <button type="button" className="text-[var(--metin-ikincil)] hover:underline" onClick={() => navigate("/ihale-ac")}>İlan aç</button>{" "}
          formu ile aynı üretim hedefi.
        </div>

        <div className="flex flex-wrap gap-2 mb-6">
          <Button size="sm" variant="outline" className="border-[var(--cizgi)] text-[var(--metin-ikincil)]" onClick={() => navigate("/onboarding/akis")}>
            Akış seçimi (demo)
          </Button>
        </div>

        <div className="p-4 rounded-[20px] bg-[var(--zemin-yumusak)] border border-[var(--cizgi)] flex gap-3 mb-10">
          ...
          <p className="text-xs text-slate-300 leading-relaxed">
            ...
            Hâlâ <strong className="text-[var(--metin-ikincil)]">mümkün olmayan</strong> kısım: gerçek e-Devlet, Findeks, banka, FCM, yayın, blockchain — sunucu ve sözleşme olmadan kod tek başına yetmez.
          </p>
        </div>
              ...
              <CardContent className="p-5">
                <div className="flex flex-wrap items-start justify-between gap-3 mb-3">
                  <div className="flex items-center gap-3">
                    <div className="p-2.5 rounded-[20px] bg-[var(--zemin-yumusak)] text-[var(--metin-ikincil)]">{modeIcon[m.id]}</div>
                    <div>
                      <h2 className="text-lg font-normal text-white">{m.title}</h2>
                      <p className="text-xs text-slate-500">{m.subtitle}</p>
                    </div>
                  </div>
                  <Badge variant="outline" className="border-[var(--cizgi)] text-[var(--metin-ikincil)] text-[10px]">
                    UI + süreç taslağı
                  </Badge>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-4 text-xs">
                  <div>
                    <p className="text-slate-500 font-normal mb-2 flex items-center gap-1"><CheckCircle2 className="w-3.5 h-3.5 text-[var(--metin-ikincil)]" /> Adımlar</p>
        ...
        <Card className="bg-slate-900/50 border-[var(--cizgi)] mb-10">
          <CardContent className="p-6">
            <div className="flex items-center gap-2 mb-4">
              <Coins className="w-6 h-6 text-[var(--metin-ikincil)]" />
              ...
              <table className="w-full text-sm min-w-[520px]">
                <thead>
                  <tr className="border-b border-slate-200 text-start text-slate-500 text-xs">
                    ...
                    <th className="py-2 pe-3 text-[var(--metin-ikincil)]">ihaleal (hedef)</th>
                ...
                <tbody>
                  {PRICING_COMPARISON.rows.map((r) => (
                    <tr key={r.label} className="border-b border-slate-200/80 text-slate-300">
                      ...
                      <td className="py-3 pe-3 text-[var(--metin-ikincil)]">{r.ihaleal}</td>
        ...
        <Card className="bg-slate-900/50 border-slate-200/80">
          <CardContent className="p-6 flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
            <div className="flex items-center gap-3">
              <Scale className="w-8 h-8 text-[var(--metin-ikincil)] shrink-0" />
              <div>

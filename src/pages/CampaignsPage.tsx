    ...
    <div className="min-h-screen bg-slate-950 px-4 pb-16 pt-24 text-slate-100 lg:px-6">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-5">
        <section className="rounded-[20px] border border-[var(--cizgi)] bg-gradient-to-r from-[var(--zemin-yumusak)] via-[var(--zemin-yumusak)] to-[var(--zemin-yumusak)] p-5">
          ...
          <div className="mt-4 grid gap-3 sm:grid-cols-3">
            {[
              ...
              <article key={metric.k} className="rounded-[20px] border border-white/15 bg-slate-900/60 p-3">
                <p className="text-[11px] uppercase tracking-[0.12em] text-slate-400">{metric.k}</p>
                <p className="mt-1 text-base font-normal text-white">{metric.v}</p>
              </article>
            ))}
          </div>
        </section>
        ...
        <section className="rounded-[20px] border border-[var(--cizgi)] bg-[var(--zemin-yumusak)] p-4">
          ...
          <h3 className="mt-2 text-xl font-normal text-white">{highlighted.title}</h3>

  ...
  return (
    <div className="min-h-screen pt-20 pb-16">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <nav
          className="sticky top-[4.5rem] z-30 mb-8 -mx-1 px-1 py-2 flex flex-wrap gap-2 rounded-[20px] border border-slate-200 bg-white/90 backdrop-blur-md"
            ...
            <table className="w-full text-start text-xs sm:text-sm">
              <thead>
                <tr className="border-b border-slate-200 bg-white/[0.03] text-slate-400">
                  <th className="p-3 font-normal">İşlem (₺)</th>
                  <th className="p-3 font-normal">Komisyon matrahı</th>

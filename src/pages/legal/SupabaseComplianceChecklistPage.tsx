  ...
  return (
    <div className="min-h-screen pt-20 pb-20 px-4">
      ...
      <div className="mx-auto max-w-4xl space-y-8">
        ...
        <div className="relative overflow-hidden rounded-[20px] border border-[var(--cizgi)] bg-gradient-to-br from-white/90 via-slate-950/95 to-slate-900/90 p-6 sm:p-8">
          ...
          <div className="relative flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            ...
            <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-[20px] bg-gradient-to-br from-[var(--zemin-yumusak)] to-[var(--zemin-yumusak)]">

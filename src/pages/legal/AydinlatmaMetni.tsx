...
import {
  ArrowLeft, Shield, FileText, CheckCircle2, Mail, Calendar,
} from "lucide-react";
    ...
    <main className="min-h-screen pt-24 pb-16 px-4 text-white">
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <article className="space-y-5">
          ...
          {/* 3. Amaçlar */}
          <section className="rounded-[20px] border border-slate-700 bg-slate-900/40 p-5 space-y-2">
            <h2 className="text-lg font-normal text-white">3. Veri İşleme Amaçları</h2>
          ...
          {/* 4. Hukuki Sebepler */}
          <section className="rounded-[20px] border border-slate-700 bg-slate-900/40 p-5 space-y-2">
            <h2 className="text-lg font-normal text-white">4. Hukuki Sebepler (KVKK m. 5)</h2>
          ...
          {/* 5. Aktarım */}
          <section className="rounded-[20px] border border-slate-700 bg-slate-900/40 p-5 space-y-2">
            <h2 className="text-lg font-normal text-white">5. Veri Aktarımı (KVKK m. 8-9)</h2>
            <p className="text-sm text-slate-300 leading-relaxed">
          ...
          {/* 7. Saklama */}
          <section className="rounded-[20px] border border-slate-700 bg-slate-900/40 p-5 space-y-2">
            <h2 className="text-lg font-normal text-white">7. Saklama Süresi</h2>
            <ul className="text-sm text-slate-300 space-y-1 list-disc list-inside ms-2">

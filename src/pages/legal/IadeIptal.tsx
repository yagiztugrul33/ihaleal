          ...
          <section className="rounded-2xl border border-emerald-500/30 bg-emerald-500/5 p-5 space-y-2">
            ...
            <ul className="text-sm text-slate-300 space-y-1.5 list-disc list-inside ms-2">
              ...
              <li><strong className="text-white">İptal yöntemi:</strong> <button type="button" onClick={() => navigate("/uyelik")} className="text-emerald-300 underline">/uyelik</button> sayfası → "Aboneliği iptal et"
                veya <a href="mailto:destek@ihaleal.com" className="text-emerald-300 underline">destek@ihaleal.com</a>.</li>
              <li><strong className="text-white">İade süresi:</strong> bildirimin ulaşmasından itibaren <strong className="text-emerald-300">14 gün içinde</strong> aynı ödeme yoluyla iade edilir.</li>
          ...
          <div className="rounded-xl border border-slate-700 bg-slate-900/40 p-4 flex items-start gap-3">
            ...
            <div className="text-sm">
              ...
              <p className="text-xs text-slate-400">
                ...
                {" · "}
                <button type="button" onClick={() => navigate("/uyelik")} className="text-cyan-300 underline">/uyelik (panel)</button>

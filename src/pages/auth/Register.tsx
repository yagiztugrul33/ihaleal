      ...
      <div className="w-full max-w-md px-4">
        ...
        <Card className="bg-slate-900/50 border-slate-200/80">
          <CardContent className="p-6 space-y-5">
            ...
            />
            {info && (
              <div className="flex items-center gap-2 p-3 rounded-[20px] bg-[var(--zemin-yumusak)] border border-[var(--cizgi)] text-[var(--metin-ikincil)] text-sm">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {isMuteahhit && (
                <>
                  <div className="rounded-[20px] border border-[var(--cizgi)] bg-[var(--zemin-yumusak)] p-3 text-xs text-[var(--metin-ikincil)]">
                    <Building2 className="w-4 h-4 inline-block me-1.5 text-[var(--metin-ikincil)]" />
              ...
              <label className="flex items-start gap-2 text-xs text-slate-400 cursor-pointer">
                ...
                <span>
                  ...
                  ve{" "}
                  <button type="button" className="text-[var(--metin-ikincil)] hover:underline" onClick={() => navigate("/gizlilik")}>
                    gizlilik
                  </button>{" "}

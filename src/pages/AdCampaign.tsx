...
export default function AdCampaign() {
  ...
  const reels = [
    ...
    { id: 4, file: "reels-04-guvenlik.mp4", title: "Güvenlik", duration: "5s", goal: "Güven", copy: "Findeks, SMS, Banka API, AML/KYC. Sahibinden kadar güvenli #güvenlik #findeks #banka" },
    ...
    { id: 7, file: "reels-07-yatirimci.mp4", title: "Yatırımcılar", duration: "5s", goal: "Niche", copy: "Portföyünü takip et, karşılaştır, en iyi fırsatları yakala #yatırım #portföy #kira" },
    ...
    { id: 12, file: "reels-02-ai-analiz.mp4", title: "AI Analiz (A/B varyant)", duration: "5s", goal: "Meta test", copy: "Yatırım skoru + bölge endeksi vurgusu — YouTube Shorts’ta ikinci başlık #ai #yatırım" },
  ];
      ...
      <div className="bg-gradient-to-b from-pink-500/5 to-transparent border-b border-white/5">
        <div className="max-w-5xl mx-auto px-4 py-12">
          ...
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              <h1 className="text-3xl font-bold text-white">Reklam Kampanya Planı</h1>
              ...
              {reels.map((r) => (
                <div key={r.id} className="p-3 rounded-xl bg-white/[0.03] border border-white/5">
                  ...
                  <div className="protected-media">
                    <video src={publicAsset(`videos/${r.file}`)} className="w-full rounded-lg mb-2" controls playsInline preload="metadata" />
                  </div>
                ...
                <div key={c.week} className="flex items-start gap-3 p-3 rounded-xl bg-white/[0.03] border border-white/5">
                  ...
                  <div>
                    <div className="flex items-center gap-2 mb-1">
                      <span className="text-sm font-semibold text-white">{c.week}</span>

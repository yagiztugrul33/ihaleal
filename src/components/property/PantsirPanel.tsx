    ...
    <section className="rounded-[20px] border border-[var(--cizgi)] bg-gradient-to-br from-slate-900/80 to-slate-950/80 p-6 shadow-xl backdrop-blur-xl">
      ...
      <div className="mb-4 grid grid-cols-2 gap-2 rounded-[20px] border border-slate-700/40 bg-slate-900/40 p-3 sm:grid-cols-4">
        <div className="flex items-center gap-2 rounded-[10px] bg-slate-800/40 px-3 py-2">
          <GraduationCap className="h-4 w-4 text-[var(--metin-ikincil)]" />
          <div>
        ...
        <div className="flex items-center gap-2 rounded-[10px] bg-slate-800/40 px-3 py-2">
          <Heart className="h-4 w-4 text-[var(--metin-ikincil)]" />
          <div>
        ...
        <div className="flex items-center gap-2 rounded-[10px] bg-slate-800/40 px-3 py-2">
          <ShoppingBag className="h-4 w-4 text-[var(--metin-ikincil)]" />
          <div>
        ...
        <div className="flex items-center gap-2 rounded-[10px] bg-slate-800/40 px-3 py-2">
          <Bus className="h-4 w-4 text-[var(--metin-ikincil)]" />
          <div>
          ...
          return (
            <button
              ...
              className={`flex items-center gap-1.5 rounded-[10px] px-3 py-1.5 text-sm font-normal transition ${
                active ? "bg-[var(--zemin-yumusak)] text-[var(--metin-ikincil)] border border-[var(--cizgi)]" : "text-slate-500 hover:text-slate-200 border border-transparent"
              }`}
            >
      ...
      <ul className="space-y-2">
        {visiblePOIs.length === 0 ? (
          ...
          visiblePOIs.map((poi, idx) => (
            <li
              key={`${poi.name}-${idx}`}
              className="flex items-center justify-between rounded-[20px] border border-slate-700/30 bg-slate-900/40 px-4 py-3 transition hover:border-[var(--cizgi)]"
            >
              <div className="flex items-center gap-3">
                <MapPin className="h-4 w-4 text-[var(--metin-ikincil)]" aria-hidden />
      ...
      {!anyLive ? (
        <div className="mt-4 rounded-[20px] border border-[var(--cizgi)] bg-[var(--zemin-yumusak)] px-4 py-3">
          <p className="text-[11px] text-[var(--metin-ikincil)] leading-relaxed">

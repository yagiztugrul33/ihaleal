  ...
  return (
    <div className="page-shell page-shell-gradient">
      <div className="pointer-events-none absolute inset-0 z-0 overflow-hidden" aria-hidden>
        {!authMinimal ? (
          <>
            <div className="absolute -top-36 left-[12%] h-[min(520px,55vw)] w-[min(520px,55vw)] rounded-full bg-amber-500/20 blur-[120px]" />
            <div className="absolute bottom-[-100px] right-[8%] h-[min(440px,48vw)] w-[min(440px,48vw)] rounded-full bg-teal-700/15 blur-[110px]" />
            <div className="absolute top-[42%] left-1/2 h-[min(680px,92vw)] w-[min(680px,92vw)] -translate-x-1/2 -translate-y-1/2 rounded-full bg-amber-200/25 blur-[130px]" />
          </>
        ) : null}
      </div>

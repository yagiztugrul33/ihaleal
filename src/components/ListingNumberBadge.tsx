...
export function ListingNumberBadge({
  ...
  return (
    <Badge
      variant="outline"
      className={`font-mono border-[var(--cizgi)] text-[var(--metin-ikincil)] bg-[var(--zemin-yumusak)] ${compact ? "text-[9px] px-1.5 py-0" : "text-[10px] sm:text-xs px-2 py-0.5"} ${className}`}

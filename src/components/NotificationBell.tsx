  ...
  return (
    <div className="relative" ref={wrapRef}>
      <button
        ...
        className="relative min-h-11 min-w-11 inline-flex items-center justify-center rounded-xl text-slate-500 hover:text-slate-900 hover:bg-white/10 transition-colors"
        aria-expanded={open}

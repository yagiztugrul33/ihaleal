...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      role="group"
      className={cn(
        "group/input-group border-input dark:bg-input/30 relative flex w-full items-center rounded-[3px] border shadow-xs transition-[color,box-shadow] outline-none",
  ...
  "text-sm shadow-none flex gap-2 items-center",
  {
    variants: {
      size: {
        ...
        sm: "h-8 px-2.5 gap-1.5 rounded-[3px] has-[>svg]:px-2.5",
        "icon-xs":

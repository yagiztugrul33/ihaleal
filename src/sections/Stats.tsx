    ...
    <section className="relative py-24">
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            { icon: <Gavel className="w-6 h-6 text-blue-400" />, value: "3.420", label: "Tamamlanan İhale", color: "bg-blue-500/10" },
            { icon: <Users className="w-6 h-6 text-teal-400" />, value: "12.847", label: "Memnun Yatırımcı", color: "bg-teal-500/10" },
            { icon: <Banknote className="w-6 h-6 text-purple-400" />, value: "₺1.846M+", label: "İşlem Hacmi", color: "bg-purple-500/10" },

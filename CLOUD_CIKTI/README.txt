Bu klasör — Cloud / uzak ajan çıktıları içindir.

Cloud agent'a verdiğiniz komut (CLOUD_KOMUTLARI.txt içindeki KOMUT A), çalışma
sonunda burada şu dosyayı oluşturmalı veya güncellemelidir:
...
İnsan ekibi: docs/OZELLIK_ENVANTERI_SAHIBINDEN_ESLENIK.txt ile bu raporu çapraz okuyun.

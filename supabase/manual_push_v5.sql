-- ihaleal.com — üyelik + hizmet + yetki + komisyon + emlakçı performans (SQL Editor)
-- Önce önceki manual_push dosyaları uygulanmış olmalı.

-- ═══════════════════════════════════════════════════════════════════════════════
-- İçerik: migration 20260429120400_memberships_service_fees_authorizations.sql
-- ═══════════════════════════════════════════════════════════════════════════════

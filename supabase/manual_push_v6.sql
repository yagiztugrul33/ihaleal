-- ihaleal.com — TUR #19 (Supabase SQL Editor)
-- Önce manual_push_v2 → v5 sırası uygulanmış olmalı (memberships + bid_bonds tabloları).

-- ═══════════════════════════════════════════════════════════════════════════════
-- İçerik: migration 20260430120000_write_policies_and_place_bid_v2.sql
-- ═══════════════════════════════════════════════════════════════════════════════

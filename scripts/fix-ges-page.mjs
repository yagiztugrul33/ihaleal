          ...
          <Card className="card-luxury border-white/10">
            <CardContent className="p-6 space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <motion.div><Label>Fiyat TRY/kWh</Label><Input value={price} onChange={(e) => setPrice(e.target.value)} className="mt-1" /></motion.div>
...
fs.writeFileSync("src/pages/intelligence/GesAnalysisPage.tsx", content, "utf8");
console.log("GesAnalysisPage.tsx written", content.length, "bytes");

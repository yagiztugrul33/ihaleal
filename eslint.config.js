...
export default defineConfig([
  globalIgnores([
    ...
    'scripts/fix-yorumlar-page.mjs',
    'scripts/gen-dalga2-pages.cjs',
    'scripts/gen-dalga3-faz2.mjs',
    'scripts/gen-lessons.mjs',
    'scripts/gen-muteahhit.cjs',
    'scripts/write-lessons.mjs',
    'scripts/write-muteahhit-panel.mjs',
    'scripts/write-yorumlar.mjs',
  ]),
  {
    files: ['src/**/*.{ts,tsx}'],
    extends: [

...
### 2. Kurumsal (büyük emlak grupları hedefli)
...
- **12 sayfalık pilot PDF:** Repoda yok; yerel dosya olarak duruyor olabilir
- **Strateji:** 30 dk görüşme + 90 günlük zero-cost pilot (hedef büyük emlak grubu ofisi)
- Hukuki çerçeve: `docs/hukuk/` — örnek referans PDF yerel `docs/hukuk/kaynak/` altında (telif)

## Sonraki Adımlar (öncelik)

### Kısa vade (1–2 hafta)

1. Hedef pilot ofisine pilot teklifi gönder **veya** Intelligence modülünü zenginleştir (karar senin)
